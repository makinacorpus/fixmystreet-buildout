* A project has been created in /tmp/tmphgsTZR.

* A minilay has been installed in /tmp/tmphgsTZR/minilays/makina.fixmystreet.
...
* The project must be archived here 'ssh://gitorious-git@gitorious.makina-corpus.net/makinacorpusfixmystreet-buildout.git' using 'git' or change the minibuild src_uri/scm_type.
